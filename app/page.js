...
export default function Home() {
    ...
    useEffect(() => {
        ...
        const distanceFactor = window.innerHeight / 20;
        // const blurFactor = 0;
    ...
    return (
        <main>
            <section ref={introRef} className={`${styles.section} h-screen flex flex-col`}>
                ...
                <div className="container mx-auto">
                    <div className="grid grid-cols-12 items-end gap-4">
                        <p className="my-0 col-span-4 md:col-span-6 uppercase font-bold text-mint">Welcome</p>
                        <div className="col-span-8 md:col-span-6 max-w-[480px]">
                            <p>
                                Elevating non-profits and startups to new heights with 15 years of design and development
                                expertise.
                            </p>
                            <p>
                                Delivering good ideas, responsive design, and clean code to meet the needs of creative directors,
